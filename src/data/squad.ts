...
// Roster cross-checked from public reporting. Attributes are TACTIC-MATCHED
// (0–100) SUBJECTIVE ESTIMATES informed by public profiles (Transfermarkt /
// FBref / FotMob) + curation — not official stats. Market values are rough
// €m estimates. Core players (Son/Lee Kang-in/Kim Min-jae) carry deep role
// profiles. See /methodology.
// ──────────────────────────────────────────────────────────────────────────

export const SQUAD_VERSION = "2026-WC-26man.v2";
...
export const squad: Player[] = [
  // ── Goalkeepers ─────────────────────────────────────────────────────────
  {
    ...
    marketValueM: 2, gkRating: 81,
    attributes: { buildUp: 58, progression: 30, finishing: 10, pressWork: 35, defending: 82, versatility: 40, ntFit: 82, form: 80 },
  ...
  },
  {
    ...
    marketValueM: 2, gkRating: 75,
    attributes: { buildUp: 66, progression: 32, finishing: 10, pressWork: 38, defending: 75, versatility: 42, ntFit: 60, form: 66 },
  ...
  },
  {
    ...
    marketValueM: 5,
    attributes: { buildUp: 73, progression: 56, finishing: 28, pressWork: 64, defending: 74, versatility: 68, ntFit: 60, form: 68 },
    strengths: ["전진 패스 능력", "6번 겸업 가능"],
  ...
  // ── Full-backs / wing-backs ───────────────────────────────────────────────
  {
    ...
    marketValueM: 7,
    attributes: { buildUp: 70, progression: 74, finishing: 38, pressWork: 76, defending: 66, versatility: 86, ntFit: 74, form: 80 },
    strengths: ["양쪽 풀백·윙백 모두 소화", "전진·연결 우수"],
    note: "스쿼드 최고 전술 유연성, 윙백 시스템 핵심",
  },
  {
  ...
  },
  {
    ...
    weaknesses: ["대표팀 호흡 적응 중", "빌드업 정교함은 발전 중"],
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  {
    ...
    strengths: ["양발 마무리·결정력", "역습·전환 파괴력", "리더십"],
