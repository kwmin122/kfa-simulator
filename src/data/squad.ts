...
export const squad: Player[] = [
  ...
  // ── Full-backs / wing-backs ───────────────────────────────────────────────
  {
    ...
    marketValueM: 7, confidence: "medium", sourceNote: SRC_TM,
    attributes: { buildUp: 70, progression: 74, finishing: 38, pressWork: 76, defending: 66, versatility: 86, ntFit: 76, form: 80 },
    strengths: ["양쪽 풀백·윙백 소화", "전진·연결", "활동량"],
    weaknesses: ["크로스 정확도 기복", "제공권 보통"],
