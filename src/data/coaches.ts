...
export const gamst: Coach = {
  ...
  formation: "4-2-4", altFormations: ["4-3-3"],
  axes: { possession: 36, pressHeight: 72, tempo: 92, width: 95, verticality: 95, buildFromBack: 32 },
  requirements: [
    { key: "paceWingers", weight: 0.98, label: "윙에 윙 — 측면 과부하" },
    { key: "mobileStriker", weight: 0.85, label: "돌격 투톱" },
    { key: "highStaminaFront", weight: 0.82, label: "전방 에너지" },
    { key: "overlappingFB", weight: 0.7, label: "풀백도 윙처럼" },
  ],
  intangibles: { complexity: 18, planB: 25, tournamentXP: 10, defensiveStability: 20, starManagement: 55 },
  meme: true,
  ...
  dna: ["윙에 윙", "닥치고 공격", "측면 과부하"],
  blurb: "윙에 윙을 또 박는 4-2-4 측면 과부하. 양쪽으로 무한히 돌격해 화력은 폭발하지만 수비 밸런스는 완전히 실종되는, 재미용 가상 후보.",
...
export const COACH_HOOKS: Record<string, string> = {
  ...
  gamst: "윙에 윙을 박는 4-2-4 측면 과부하 — 화력은 폭발하지만 수비는 완전히 실종되는 재미용 가정입니다",
